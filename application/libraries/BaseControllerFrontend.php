 ...
 */
class BaseControllerFrontend  extends CI_Controller {
	protected $role = '';
	protected $vendorId = '';
	protected $name = '';
	protected $roleText = '';
	...
	function isLoggedIn() {
		...
		if (! isset ( $isLoggedIn ) || $isLoggedIn != TRUE) {
			...
			$this->global ['services_info'] = $this->cm->categoryListing('',10,0);
	 ...
	 */
	function loadThis() {
		$this->global ['pageTitle'] = WEB_NAME.' : Access Denied';
		
		$this->load->view ( 'b2c/includes/header', $this->global );
		$this->load->view ( 'general/access' );
		$this->load->view ( 'b2c/includes/footer' );
	}
    ...
    function loadViews($viewName = "", $headerInfo = NULL, $pageInfo = NULL, $footerInfo = NULL){
		// pre($this->global); die;
        $this->load->view('b2c/includes/header', $headerInfo);
        $this->load->view($viewName, $pageInfo);
        $this->load->view('b2c/includes/footer', $footerInfo);
    }
