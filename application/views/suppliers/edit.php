                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" class="form-control" id="password" placeholder="Password" value="sp123456" name="password" maxlength="20">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <!-- <label for="cpassword">Confirm Password</label> -->
                                        <input type="hidden" class="form-control" id="cpassword" placeholder="Confirm Password" value="sp123456" name="cpassword" maxlength="20">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
