                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td><?php 
                             if($record->role_type == SYSTEM_ADMIN){
                                echo 'System Administrator';
                             }else if($record->role_type == AGENT_USER){
                                echo 'Agent | Agencies (B2B)';
                             } else if($record->role_type == REGULAR_USER){ 
                                echo 'Regular User (B2C)';
                             }else if($record->role_type == SUPPLIER_USER ) {
                                echo 'Supplier User (B2C)';
                             }else if($record->role_type == SUPPLIER_USER ) {
                                echo '<i><u>Unknown!</u></i>';
                             }
                         ?></td>
                        <td>
                            <?php 
                        ...
                        <td class="text-center">
                            <a class="btn btn-sm btn-info" href="<?php echo base_url().'roles/edit/'.$record->roleId; ?>" ><i class="fa fa-pencil"></i></a>
                           <?php if($record->roleId != '1') { ?>
