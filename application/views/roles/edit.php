                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control required" id="isAdmin" name="role_type">
                                            <option value="">Select type</option>
                                            <option value="<?= SYSTEM_ADMIN ?>" <?= ( $roleType == SYSTEM_ADMIN )? 'selected' : '' ?> >System Administrator</option>
                                            <option value="<?= AGENT_USER ?>" <?= ( $roleType == AGENT_USER )? 'selected' : '' ?> > Agent | Agencies</option>
                                            <option value="<?= REGULAR_USER ?>" <?= ( $roleType == REGULAR_USER )? 'selected' : '' ?> >Regular User</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                    ...
                    <form method="POST" action='<?php echo base_url() ?>roles/storeAccessMatrix'>
                        ...
                        <div class="box-body table-responsive no-padding">
                            <table class="table table-hover">
                                ...
                                ?>
                                    <tr>
                                        <td><b><?php echo ucwords(str_replace('_' ,' ',$record['module'] )) ?></b> <input type="hidden" name="access[<?= $record['module'] ?>][module]" value="<?php echo $record['module'] ?>" /> </td>
