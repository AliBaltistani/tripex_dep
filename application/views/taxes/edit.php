            ...
            <div class="col-md-8">
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Edit Tax Details</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control required" placeholder="Enter Sale Tax" value="<?= $prices->sale_tax ?>" id="sale_tax" name="sale_tax" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="radio" class=" required" name="tax_type" id="tax_type1" value="1" <?= ($prices->tax_type == 1)? 'checked': '' ?>>
                                        <label for="tax_type1" > Count as Percentage</label> 
                                        &nbsp; &nbsp; &nbsp;
                                        <input type="radio" class="required" name="tax_type" id="tax_type2" value="2" <?= ($prices->tax_type == 2)? 'checked': '' ?>>
