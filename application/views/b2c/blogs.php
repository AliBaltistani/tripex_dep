...
<a href="<?= base_url() ?>blog-detail" class="card-img"><img src="assets/images/Dubai-23.jpg" alt></a>
<a href="<?= base_url() ?>blog-detail" class="date">
...
<ul>
<li>
By <a href="<?= base_url() ?>blog-detail">Traveler Point</a>
</li>
<li>
<a href="<?= base_url() ?>blog-detail">Adventure</a>
</li>
</ul>
</div>
<h5><a href="<?= base_url() ?>blog-detail">Sofitel Dubai The Palm Resort And Spa</a></h5>
<div class="bottom-area">
<a href="<?= base_url() ?>blog-detail">View Post
<span>
...
<div class="blog-card">
<div class="blog-card-img-wrap">
<a href="<?= base_url() ?>blog-detail" class="card-img"><img src="assets/images/Dubai-28.jpg" alt></a>
<a href="<?= base_url() ?>blog-detail" class="date">
<span><strong>20</strong> <br> August</span>
</a>
</div>
...
<h5><a href="<?= base_url() ?>blog-detail">Explore Dubai’s Old Town</a></h5>
<div class="bottom-area">
<a href="<?= base_url() ?>blog-detail">View Post
<span>
<svg xmlns="http://www.w3.org/2000/svg" width="14" height="12" viewBox="0 0 14 12" fill="none">
...
<div class="blog-card">
<div class="blog-card-img-wrap">
<a href="<?= base_url() ?>blog-detail" class="card-img"><img src="assets/images/headup.jpg" alt></a>
<a href="<?= base_url() ?>blog-detail" class="date">
<span><strong>20</strong> <br> August</span>
</a>
</div>
...
<h5><a href="<?= base_url() ?>blog-detail">Head Up The Burj Khalifa</a></h5>
<div class="bottom-area">
<a href="<?= base_url() ?>blog-detail">View Post
<span>
<svg xmlns="http://www.w3.org/2000/svg" width="14" height="12" viewBox="0 0 14 12" fill="none">
...
<div class="blog-card">
<div class="blog-card-img-wrap">
<a href="<?= base_url() ?>blog-detail" class="card-img"><img src="assets/images/Dubai-7.jpg" alt></a>
<a href="<?= base_url() ?>blog-detail" class="date">
<span><strong>20</strong> <br> August</span>
</a>
</div>
...
<h5><a href="<?= base_url() ?>blog-detail">Lunch At Switch Restaurant, The Dubai Mall</a></h5>
<div class="bottom-area">
<a href="<?= base_url() ?>blog-detail">View Post
<span>
<svg xmlns="http://www.w3.org/2000/svg" width="14" height="12" viewBox="0 0 14 12" fill="none">
