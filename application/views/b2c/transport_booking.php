...
<form action="<?= base_url('b2c/booking-confirm?serviceId=' . $sid) ?>" method="POST">
    <div class="booking-form-wrap mb-40">
        ...
        <h4 style="font-size: 16px;" ><?= substr($sTitle,20)?? '' ?></h4>
        <hr>
        ...
        <div class="tab-content" id="v-pills-tabContent2">
            <div class="tab-pane fade active show" id="v-pills-booking" role="tabpanel" aria-labelledby="v-pills-booking-tab">
                <div class="sidebar-booking-form">
                    ...
                    <div class="tour-date-wrap mb-25">
                        <h6>Select your Pickup Time:</h6>
                        <div class="form-check customdate">
                            <!-- <input class="form-check-input" type="radio" name="tourDate" id="Coustom" value="option1" checked> -->
                            <label class="form-check-label" for="Coustom">
                            </label>
                            <span class="form-group">
                                <input type="time" name="pickupTime" placeholder="5 Mar, 2024" value="">
                            </span>
                        </div>
                        <?= '<small>' . $this->form_validation->error('tourDate') . '</small>' ?>
                    </div>
                ...
                <input type="text" name="pickupLoc" value="<?= set_value('pickupLoc'); ?>" placeholder="Enter your pickup location">
                <?= '<small>' . $this->form_validation->error('pickupLoc') . '</small>' ?>
            </div>
            <div class="form-inner mb-20">
                <label>Drop Off Location <span>*</span></label>
                <input type="text" name="dropOffLoc" value="<?= set_value('dropOffLoc'); ?>" placeholder="Enter your drop off locations">
                <?= '<small>' . $this->form_validation->error('dropOffLoc') . '</small>' ?>
            </div>
                    ...
                    <div class="booking-form-item-type mb-45">
                        ...
                        <div class="number-input-item adults">
                            ...
                            <div class="quantity-counter">
                                ...
                                <input type="text" name="quantity_adult" id="quantity_input_adult"  class="quantity__input_disabled" min="0" max="<?= (int) $passengers; ?>" value="0" required>
                    ...
                    <div class="booking-form-item-type">
                        ...
                        // if($pChild != "0"){ 
                        ?>
                        <div class="single-total mb-30" style="display:none;">
                            <span>Children</span>
                            <ul>
                        ...
                        // }else{
                        ?>
                            <input type="hidden" name="quantity_child" id="quantity_child" value="0">
                            <?php 
                            // }
                            ?>
                             <div class="form-inner mb-20">
                            <label>Special Request/Driver Note</label>
                            <textarea name="sp_note" row="10" col="5" placeholder="Write a note or special request for driver (if any)"></textarea>
                        </div>
                    </div>
...
<script>
	$(document).ready(function() {
		...
		$("#quantity_plus_adult").click(function(e) {
			...
			let value = parseInt(quantityAdult)
			if(has_capacity()){
				    value = value + 1;
				}
				$("#quantity_input_adult").val(value);
				quantityAdult = $("#quantity_input_adult").val();
		...
		$("#quantity_plus_child").click(function(e) {
			e.preventDefault();
			    ...
			    quantitychild = $("#quantity_input_child").val();
			   let	value = parseInt(quantitychild)
				if(has_capacity()){
				    value = value + 1;
				}
				$("#quantity_input_child").val((value));
				quantitychild = $("#quantity_input_child").val();
