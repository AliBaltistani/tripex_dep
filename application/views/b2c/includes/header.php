...
<body>
    ...
    <div class="right-sidebar-menu">
        <div class="sidebar-logo-area d-flex justify-content-between align-items-center">
            <div class="sidebar-logo-wrap">
                <a href="<?= base_url() ?>"><img alt="image" src="<?= base_url() ?>assets/images/travler.png" style="width: 192px;"></a>
            </div>
        ...
        <div class="sidebar-bottom">
            <div class="hotline-area">
                ...
                <div class="content">
                    ...
                    <h6><a href="tel:<?= web_info('contact'); ?>"><?= web_info('contact'); ?></a></h6>
                </div>
            </div>
            <div class="email-area">
                ...
                <div class="content">
                    <span>Email:</span>
                    <h6><a href="mailto:<?= web_info('email_address'); ?>"><span class="__cf_email__" data-cfemail="<?= web_info('email_address'); ?>">[email&#160;protected]</span></a></h6>
                </div>
            </div>
        </div>
    </div>
    <?php require_once('login_model.php') ?>
    <div class="top-bar style-2">
        ...
        <p>
            <?php if(isset($_SESSION['isLoggedIn']) && $_SESSION['isLoggedIn'] == true){  ?>
               <a href="<?= base_url('logout') ?>" class="primary-btn1"  style="color:white;">logout</a>
            <?php }else{ ?>
                <a href="#0" class="primary-btn1" data-bs-toggle="modal" onclick="OnGuestLogin()" data-bs-target="#user-login" style="color:white;">Login</a>
                <a href="#0" class="primary-btn1" data-bs-toggle="modal" onclick="OnAgentLogin()" data-bs-target="#user-login" style="color:white;">Agent Login </a>
          <?php } ?>
        </p>
        <div class="topbar-right">
            <div class="social-icon-area">
                <ul>
                    <li><a href="<?= web_info('fb_link'); ?>"><i class="bx bxl-facebook"></i></a></li>
                    <li><a href="<?= web_info('x_link'); ?>"><svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" fill="currentColor" class="bi bi-twitter-x" viewBox="0 0 16 16">
                                <path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865l8.875 11.633Z" />
                            </svg></a></li>
                    <li><a href="<?= web_info('linkedin_link'); ?>"><i class="bx bxl-youtube"></i></a></li>
                    <li><a href="<?= web_info('inst_link'); ?>"><i class="bx bxl-instagram"></i></a></li>
                    <li><a href="https://wa.me/<?= web_info('whatstapp'); ?>"><i class="bx bxl-whatsapp"></i></a></li>
    ...
    <header class="header-area style-3">
        <div class="header-logo d-lg-none d-flex">
            <a href="<?= base_url() ?>"><img alt="image" class="img-fluid" src="<?= base_url() ?>assets/images/travler.png" style="width: 192px;"></a>
        </div>
        <div class="company-logo d-lg-flex d-none">
            <a href="<?= base_url() ?>"><img src="<?= base_url() ?>assets/images/travler.png" style="width: 192px;"></a>
        </div>
        <div class="main-menu">
            ...
            <ul class="menu-list">
                <li class="active">
                    <a href="<?= base_url() ?>" class="drop-down">Home</a>
                </li>
                <li>
