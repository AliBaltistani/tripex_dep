    ...
    <footer class="main-footer">
        <div class="pull-right hidden-xs">
          <b><?=WEB_NAME?></b> Admin System | Version 1.0
        </div>
        <strong>Copyright &copy; 2024 <a href="<?php echo base_url(); ?>"></a><?=WEB_NAME?>. </strong> All rights reserved.
    </footer>
    ...
    <!-- <script src="<?php echo base_url(); ?>assets/admin/fileUpload/fileUpload.js"></script> -->
