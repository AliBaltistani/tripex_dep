                ...
                <div class="box box-primary">
                    ...
                    <form role="form" action="<?php echo base_url() ?>editUser" method="post" id="editUser" role="form">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control required" id="isAdmin" name="isAdmin">
                                            <option value="<?= REGULAR_USER ?>" <?php if($isAdmin == REGULAR_USER) {echo "selected=selected";} ?>>Normal User</option>
                                            <option value="<?= SYSTEM_ADMIN ?>" <?php if($isAdmin == SYSTEM_ADMIN) {echo "selected=selected";} ?>>System Administrator</option>
                                            <option value="<?= AGENT_USER ?>" <?php if($isAdmin == AGENT_USER) {echo "selected=selected";} ?> > Agent | Agencies</option>
                                            <option value="<?= SUPPLIER_USER ?>" <?php if($isAdmin == SUPPLIER_USER) {echo "selected=selected";} ?> >Supplier</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                        ...
                        <div class="box-footer">
                            ...
                            <a class="btn btn-default" href="<?= base_url('userListing') ?>">Back</a>
                        </div>
                    </form>
                </div>
            </div>
