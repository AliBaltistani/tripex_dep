...
define('WEB_NAME',                          "Dubai Traveler Point");
define('SYSTEM_ADMIN',                          1);
define('REGULAR_USER',                          2);
define('AGENT_USER',                            3);
define('SUPPLIER_USER',                         4);
define('GUEST_USER',                            5);

define('SEGMENT',								2);
define('SEGMENT_THREE',								3);
define('SEGMENT_FOUR',								4);
...
define('CANCEL',								3); // STATUS InActive
/************************** EMAIL CONSTANTS *****************************/

define('EMAIL_FROM',                            'saibatool511@gmail.com');		// e.g. email@example.com
define('EMAIL_BCC',                            	'saibatool511@gmail.com');		// e.g. email@example.com
define('FROM_NAME',                             'CIAS Admin System');	// Your system name
define('EMAIL_PASS',                            'mbfx rsug pnwc tlhw');	// Your email password
...
define('SMTP_USER',                             'saibatool511@gmail.com');		// your smtp user
define('SMTP_PASS',                             'mbfx rsug pnwc tlhw');	// your smtp password
