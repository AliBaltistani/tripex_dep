...
/**
 * Class : Supplier_model (User Model)
 * Supplier model class to get to handle Supplier related data 
 * @author : Mali
 * @version : 1.1
...
class Supplier_model extends CI_Model
{
    ...
    function supplierListingCount($searchText)
    {
        ...
        if(!empty($searchText)) {
            $likeCriteria = "(BaseTbl.email  LIKE '%".$searchText."%'
                            ...
                            OR  BaseTbl.mobile  LIKE '%".$searchText."%') AND BaseTbl.isAdmin = ".SUPPLIER_USER;
     ...
     */
    function supplier_listing($searchText, $page, $segment)
    {
     ...
     */
    function addNewSupplier($userInfo, $bookingId = 0)
    {
