...
class User extends BaseController
{
    ...
    function userListing()
    {
        ...
        {        
            ...
            $this->global['pageTitle'] = WEB_NAME.' : User Listing';
    ...
    function addNew()
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = WEB_NAME.' : Add New User';
    ...
    {
        $this->global['pageTitle'] = WEB_NAME.' : 404 - Page Not Found';
    ...
    function loginHistoy($userId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = WEB_NAME.' : User Login History';
    ...
    function profile($active = "details")
    {
        ...
        $this->global['pageTitle'] = $active == "details" ? WEB_NAME.' : My Profile' : WEB_NAME.' : Change Password';
